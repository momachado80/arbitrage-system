...
export const SHADOW_PROFILES: ShadowProfileConfig[] = [
  ...
  {
    profileId: "shadow_1000_structural_fillrelax_capfloorrelax_degratiorelax_v1",
    label: "Structural fill+capfloor+degratio-relax: pair×fill0.1-0.5×capfloor3%×degratio0.20 (v1)",
    startingCapital: 5000,
    latencyProfile: "normal",
    maxCapitalPerTrade: 150,
    maxCapitalPerCluster: 400,
