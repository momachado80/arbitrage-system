...
export function getSeededHistoricalEntries(): ExperimentLedgerEntry[] {
  ...
  return [
    ...
    },
    {
      ...
      endTimestamp: now,
      decision: "failed",
      decisionReason: "Operational inviability: threshold 0.5 descalibrated for real regime (p50~0.23); blocked all entries.",
      notes: "fillGuardDiagnostics showed avgRejectedFillRatio~0.236, p50~0.229. Replaced by fillguard_cal (0.24).",
    },
    {
      experimentId: "exp-fillguard_cal_v1",
      challengerProfileId: "shadow_1000_adapt_captrade_exitrefine_fillguard_cal_v1",
      familyId: "fillguard_cal_refinement",
      baseProfileId: "shadow_1000_adapt_captrade_exitrefine_v1",
      hypothesis: "Fill guard calibrated to real regime (p50~0.23); minFillRatioToTrade=0.24.",
      isolatedVariable: "minFillRatioToTrade",
      activationMode: "manual",
      status: "failed",
      startTimestamp: "2024-01-01T00:00:00.000Z",
      endTimestamp: now,
      decision: "failed",
      decisionReason: "Better avgFillRatio but worse economics; entry quality is the bottleneck.",
      notes: "totalClosed 360 vs 500; avgRealizedPnL -2.95 vs -2.61. Replaced by entrycal_bind (0.025).",
    },
    {
      experimentId: "exp-entrycal_bind_v1",
      challengerProfileId: "shadow_1000_adapt_captrade_exitrefine_entrycal_bind_v1",
      familyId: "entrycal_bind_refinement",
      baseProfileId: "shadow_1000_adapt_captrade_exitrefine_v1",
      hypothesis: "Entry threshold 0.025 to bind vs p50~0.042; 0.008 was too loose.",
      isolatedVariable: "minNetCapturableEdgeToTrade",
      activationMode: "manual",
      status: "available",
      startTimestamp: now,
      decision: undefined,
      decisionReason: undefined,
      notes: "Calibrated from selectionDiagnostics. Single-variable vs exitrefine_v1. Replaces fillguard_cal (not promoted).",
    },
    {
